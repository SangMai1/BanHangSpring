...
public interface BillRepository extends CrudRepository<Bills, Long> {
	...
	void insertBill(@Param("bill_id") Long bill_id, @Param("bill_name") String bill_name, @Param("bill_email") String bill_email, @Param("bill_phone") String bill_phone, @Param("bill_address") String bill_address, @Param("bill_date") Date bill_date, @Param("bill_status") Boolean bill_status);
